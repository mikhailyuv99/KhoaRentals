  ...
  return (
    ...
    >
      <div className="relative h-[370px] w-full overflow-hidden">
        <Image src={listing.image} alt={listing.title} fill sizes="(max-width: 1024px) 90vw, 434px" className="object-cover" />
      </div>
      ...
      <div className="p-[18px]">
        ...
        <div className="mt-3 text-[22px] font-medium leading-[1.1] text-[color:var(--text)]">
          {formatUsdCompact(listing.priceUsdMonth)}
        </div>
        ...
        <div className="mt-4 flex items-center gap-6 text-[17px] text-[color:var(--text2)]">
          ...
          <div className="flex items-center gap-[6px]">
            ...
            <span>{listing.sizeSqft.toLocaleString("en-US")} sq.ft</span>
          </div>
        </div>
      </div>
    </Link>
