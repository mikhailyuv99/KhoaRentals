...
export function PropertyCard({ property }: { property: Property }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group overflow-hidden border border-black/10 bg-[var(--background)] transition",
      ...
      <div className="relative aspect-[16/11] w-full overflow-hidden">
        ...
        <div className="absolute left-4 bottom-4 right-4">
          <div className="flex items-center justify-between gap-3">
            <div className="text-sm font-medium text-white">{property.type}</div>
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-1 text-sm text-black/55">{property.neighborhood}</div>
          </div>
        </div>

        <div className="mt-4 flex flex-wrap gap-2 text-xs text-black/65">
          <span className="border border-black/10 bg-black/0 px-3 py-1">
