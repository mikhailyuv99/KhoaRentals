...
export function Footer() {
  return (
    <footer className="mt-24 border-t border-[color:var(--ui3)] bg-white">
      <Container className="max-w-[1300px] px-10 py-14">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-[color:var(--ui3)] pt-6 text-[14px] text-[color:var(--text2)] sm:flex-row sm:items-center sm:justify-between">
